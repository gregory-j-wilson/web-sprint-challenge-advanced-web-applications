...
1. Explain what a token is used for.
    ...
    It gives access to private routes and can be used to signify one is logged in.

2. What steps can you take in your web apps to keep your data secure?

    Use tokens and private routes

3. Describe how web servers work.

    web servers are computers that hold the code for websites, but also the actual program that runs that has data, etc...
    The server holds data that can be accessed via axios get request for example, and it also holds info telling how to deal with get or put or post or delete requests in axios.  The website code reaches out to the server to get data, and/or to get the token.
